...
<link rel="stylesheet" href="css/homepage(pasien).css" type="text/css">
        ...
        <article class="one_third">
          <figure><img src="img/heart-shape-icon.jpg"  width="290" height="180" alt="">
            <figcaption>
              ...
              <footer class="more"><a href="Layanan_klinik(pasien).php">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
        <article class="one_third">
          <figure><img src="img/sch jpg.jpg"; width="290" height="180" alt="">
            <figcaption>
              ...
              <footer class="more"><a href="Jadwal_klinik(pasien).php">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
        <article class="one_third lastbox">
          <figure><img src="img/825429430.png"; width="290" height="180" alt="">
            <figcaption>
              ...
              <footer class="more"><a href="Cabang_klinik(pasien).php">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
      </section>

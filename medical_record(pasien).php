...
<div class="wrapper row2">
  ...
  <center>
  <h3>Medical record anda</h3>
   <table id="tabledatadiri">
   	<tr>
    	<td width="300">Medical Record</td>
        <td width="300">: <?php echo $row_kokidatadirisession['Medical_record']; ?></td>
    </tr>
    <tr>
    	<td width="300">Diperiksa oleh</td>
        <td>: <?php echo $row_kokidatadirisession['Diperiksa_oleh']; ?></td>
    </tr>
    <tr>
    	<td width="300">Diperiksa pada tanggal</td>
        <td>: <?php echo $row_kokidatadirisession['Diperiksa']; ?></td>
    </tr>
   </table>
   </center>
   </div>
